...
public enum ErrorCodeResponse {
    NAME_CONFLICT, ISO_CODE_CONFLICT, CASCADE_DELETE_ERROR, ATTRACTION_ALREADY_ADDED_TO_TRIP, OBJECT_NOT_FOUND, BAD_REQUEST, INTERNAL_SERVER_ERROR;
    ...
    public static ErrorCodeResponse from(BaseApiException.ErrorCode errorCode) {
        return switch (errorCode) {
            ...
            case DUPLICATE_ISO_CODE -> ISO_CODE_CONFLICT;
