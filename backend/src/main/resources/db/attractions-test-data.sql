...
INSERT INTO trip_attraction(created_on, attraction_id, trip_id, status, rating, note, must_visit)
	VALUES
	('2024-08-20T22:32:11', 1, 1, 'PLANNED', 'EXCELLENT', null, false),
    ('2025-09-10T08:12:43', 2, 1, 'PLANNED', 'AVERAGE', null, false),
    ('2025-09-12T08:12:43', 3, 1, 'PLANNED', 'EXCELLENT', 'test note', true),
    ('2025-10-14T09:47:23', 1, 2, 'VISITED', 'VERY_GOOD', null, true)
     ON CONFLICT (id) DO NOTHING;