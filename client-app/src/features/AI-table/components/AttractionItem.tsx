...
const AttractionItem: React.FC<AttractionItemProps> = ({
  ...
  const startEditHours = () => {
    if (readOnly) return;
    setHoursDraft(attraction.workingHours || "");
  ...
  const startEditVisit = () => {
    if (readOnly) return;
    setVisitDraft(attraction.VisitTime || "");
    ...
    <div className={containerClasses}>
      <div className="attraction-line">
        <button
          ...
          onClick={() => {
            ...
            if (isTopAttractions) {
              htmlContent = attraction.mustVisit
                ? `<b>★ ${text}</b>`
                : `<b>${text}</b>`;
        ...
        {onToggleMustVisit && !readOnly && (
          <button
            ...
            title={
              attraction.mustVisit ? "Unmark must visit" : "Mark must visit"
            }
          >
        ...
        {attraction.isCountrywide && (
          <span
            ...
            title="Countrywide attraction"
            aria-label="Countrywide attraction"
          >
            🏳️
          </span>
        )}
      ...
      {(attraction.address || attraction.category) && (
        <div className="attraction-address-line">
          ...
          {attraction.category && (
            <span className="attraction-category-text">
              {attraction.category}
            </span>
          )}
        </div>
            ...
            <>
                ...
                <span className="hours-segment">
                  ...
                  {!readOnly &&
                    ...
                    onUpdateWorkingHours && (
                      <button
                        type="button"
                        className="hours-add-btn"
                        onClick={startAddHours}
              ...
              {attraction.VisitTime && (
                <span className="visit-time-segment">
                  <span className="visit-time-text">
                    {attraction.VisitTime}
                  </span>
      ...
      {(attraction.note ||
        ...
        <div>
            ...
            <div className={`sticky-note${reviewMode ? " review-muted" : ""}`}>
              {!editing && (
                <>
                  ...
                  {attraction.optimalVisitPeriod && (
                    <div>
                      Optimal visit time: {attraction.optimalVisitPeriod}
                    </div>
                  )}
                  {!readOnly &&
                    onUpdateNote &&
          ...
          {attraction.infoFrom && (
            <div className="attraction-info-from">
