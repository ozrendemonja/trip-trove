...
export enum CategoryType {
  POINT_OF_INTEREST_AND_LANDMARK = "POINT_OF_INTEREST_AND_LANDMARK",
  HISTORIC_SITE = "HISTORIC_SITE",
  RELIGIOUS_SITE = "RELIGIOUS_SITE",
  ARENA_AND_STADIUM = "ARENA_AND_STADIUM",
  OTHER_LANDMARK = "OTHER_LANDMARK",
  SPECIALITY_MUSEUM = "SPECIALITY_MUSEUM",
  ART_MUSEUM = "ART_MUSEUM",
  HISTORY_MUSEUM = "HISTORY_MUSEUM",
  SCIENCE_MUSEUM = "SCIENCE_MUSEUM",
  OTHER_MUSEUM = "OTHER_MUSEUM",
  PARK = "PARK",
  NATURE_AND_WILDLIFE_AREA = "NATURE_AND_WILDLIFE_AREA",
  OTHER_NATURE_AND_PARK = "OTHER_NATURE_AND_PARK",
  LAND_BASED_ACTIVITY = "LAND_BASED_ACTIVITY",
  AIR_BASED_ACTIVITY = "AIR_BASED_ACTIVITY",
  WATER_BASED_ACTIVITY = "WATER_BASED_ACTIVITY",
  OTHER_OUTDOOR_ACTIVITY = "OTHER_OUTDOOR_ACTIVITY",
  SPORTING_EVENT = "SPORTING_EVENT",
  CULTURAL_EVENT = "CULTURAL_EVENT",
  THEATRE_EVENT = "THEATRE_EVENT",
  OTHER_EVENT = "OTHER_EVENT",
  SHOPPING = "SHOPPING",
  ZOO_AND_AQUARIUM = "ZOO_AND_AQUARIUM",
  NIGHTLIFE = "NIGHTLIFE",
  FOOD = "FOOD",
  DRINK = "DRINK",
  WILDLIFE_TOUR = "WILDLIFE_TOUR",
  EXTREME_SPORT_TOUR = "EXTREME_SPORT_TOUR",
  OTHER_TOUR = "OTHER_TOUR",
  WATER_AND_AMUSEMENT_PARK = "WATER_AND_AMUSEMENT_PARK",
  FILM_AND_TV_TOUR = "FILM_AND_TV_TOUR",
  CLASS_AND_WORKSHOP = "CLASS_AND_WORKSHOP",
  OTHER_FUN_AND_GAME = "OTHER_FUN_AND_GAME",
  SPA_AND_WELLNESS = "SPA_AND_WELLNESS",
  EATERY = "EATERY",
  BEVERAGE_SPOT = "BEVERAGE_SPOT"
}

export enum AttractionType {
  IMMINENT_CHANGE = "IMMINENT_CHANGE",
