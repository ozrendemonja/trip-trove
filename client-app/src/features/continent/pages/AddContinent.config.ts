...
import { ContinentFormFieldProps, AddContinentFormElements } from "./AddContinent.types";
...
export const useContinentFormField = (): ContinentFormFieldProps => {
    ...
    const continentNameField = {
        ...
        onGetErrorMessage: (value: string) => touched.continentName ? errorMessage : undefined,
