import { addMonths, addYears, DatePicker, defaultDatePickerStrings, FontIcon, IDatePickerStrings, IDatePickerStyles, Stack } from "@fluentui/react";

const datePickerStyles: Partial<IDatePickerStyles> = { root: { width: 100, color: "#fec703", backgroundColor: "white" }, icon: { color: "#fec703" } };
...
const DatePickerMy: React.FunctionComponent = props => {
    ...
    return (
        <Stack tokens={{ childrenGap: 0 }} horizontal={true}>
            ...
            <div style={{ padding: "5px" }}>
                <FontIcon aria-label="Compass" iconName="ChromeBackMirrored" style={{
                    color: "#fec703",
                    position: "relative",
                    top: "calc(50% - 10px)"
                }} />
